 ...
 */
public class InsertApplicationType {
     ...
     * @param afm
     */
    public InsertApplicationType(String appName, String obs)
    {
        if(appName.length()>0 )
        {
            ...
            if (!(obs.length()>0))
            obs = "";
            String sql = "insert into applicationtype (application,observations) values ('"+appName+"','"+obs+"')";
     ...
     * @param afm
     */
    public InsertApplicationType(String cid, String cName, String obs)
    {
