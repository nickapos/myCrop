 ...
 * @author nickapos
 */
public class ImportCropFieldsTable extends ImportFile {

    public ImportCropFieldsTable() {
        super.setFileName("fieldsCsv.csv");
        ...
        while (b.hasNext()) {
            ...
            if (line != null) {
                ...
                if (splitLine[0].length() > 0 && splitLine[1].length() > 0 && splitLine[2].length() > 0) {
                   ...
                   // InsertFarmField ins = new InsertFarmField(splitLine[0], splitLine[1], splitLine[2]);
                }
