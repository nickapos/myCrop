 ...
 * @author nickapos
 */
public class ImportNutrientTypeTable extends ImportFile{
    public ImportNutrientTypeTable()
    {
        super.setFileName("nutrienttypeCsv.csv");
    }
        ...
        while (b.hasNext()) {
            ...
            if (line != null) {
                ...
                if(splitLine[0].length()>0&&splitLine[1].length()>0&&splitLine[2].length()>0&&splitLine[3].length()>0&&splitLine[4].length()>0)
                {
                    ...
                    InsertNutrientType ins = new InsertNutrientType(splitLine[0],splitLine[1],splitLine[2],splitLine[3],splitLine[4]);
                }
