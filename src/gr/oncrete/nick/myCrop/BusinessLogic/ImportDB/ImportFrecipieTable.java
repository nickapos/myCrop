 ...
 * @author nickapos
 */
public class ImportFrecipieTable extends ImportFile{
    public ImportFrecipieTable()
    {
        super.setFileName("frecipieCsv.csv");
    }
        ...
        while (b.hasNext()) {
            ...
            if (line != null) {
                ...
                if(splitLine[0].length()>0&&splitLine[1].length()>0&&splitLine[2].length()>0&&splitLine[3].length()>0&&splitLine[4].length()>0)
                {
                    ...
                    InsertFertRecipy ins = new InsertFertRecipy();
                    ins.insertFrecipyWithIDs(splitLine[0],splitLine[1],splitLine[2],splitLine[3],splitLine[4]);
                }
