 ...
 * @author nickapos
 */
public class SelectAllApplicationTypeDetails extends SelectAllIDS {

    protected ArrayList rows = new ArrayList();
    protected String sql1 = "select apid,application,observations from applicationtype";

    public SelectAllApplicationTypeDetails() {
    ...
    protected void readDBReport() {
        ...
        if (results.isEmpty()) {
            ...
            for (int i = 0; i < results.size(); i += 3) {
                //with ids
                String [] row = { (String)results.get(i),(String) results.get(i + 1),(String) results.get(i + 2) };
