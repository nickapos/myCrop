 ...
 */
/*
 * this class will be used as a container for the fill details of the fertiliser recipy table
 */
 ...
 * @author nickapos
 */
public class SelectAllFertRecipyDetails extends SelectAllIDS {

    protected ArrayList rows = new ArrayList();
    protected String sql1 = "select frid,cid,nutid,quantity,observations from frecipy";

    public SelectAllFertRecipyDetails() {
    }
