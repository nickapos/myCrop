 ...
 * @author nickapos
 */
public class SelectAllProductionDetailsForASpecificCropInPeriod extends SelectAllProductionDetailsForASpecificCrop {
    ...
    public SelectAllProductionDetailsForASpecificCropInPeriod(String cType,String period) {
        sql1=sql+" and d.cropName='"+cType+"'"+period ;
