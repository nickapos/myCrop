 ...
 * @author nickapos
 */
public class SelectAllProductionDetails extends SelectAllIDS {

    protected ArrayList rows = new ArrayList();
    protected String sql1 = "SELECT id,fieldname,cropname,dateofharvest,quantity,observations FROM production a,cropfields b,farmfield c, croptype d where a.cfid=b.cfid and b.cid=d.cid and b.fid=c.fid";

    public SelectAllProductionDetails() {
    }
