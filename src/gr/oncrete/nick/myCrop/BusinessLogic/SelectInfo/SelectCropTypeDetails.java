 ...
 */
public class SelectCropTypeDetails {

    private String name, ob, id;
    private boolean exists = false;
    private String sql1 = "select cid,cropname,observations from croptype where";
    private SelectFromTable sel = new SelectFromTable();

    public SelectCropTypeDetails() {
    }

    public void SelectCropTypeDetailsWithName(String n) {
        String sql = sql1 + " cropname='" + n + "';";
        //System.out.println(sql);
        this.splitResults(sql);
    }

  
    public void SelectCropTypeDetailsWithID(String id) {
