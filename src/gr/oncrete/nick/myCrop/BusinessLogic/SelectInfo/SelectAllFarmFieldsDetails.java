 ...
 * @author nickapos
 */
public class SelectAllFarmFieldsDetails extends SelectAllIDS {

    protected ArrayList rows = new ArrayList();
    protected String sql1 = "select fid,fieldname,area,northborder,eastborder,southborder,westborder,observations from farmfield";

    public SelectAllFarmFieldsDetails() {
    }
