 ...
 * @author nickapos
 */
public class SelectAllNutrientTypeDetails extends SelectAllIDS {

    protected ArrayList rows = new ArrayList();
    protected String sql1 = "select nutid,nutname,nutsymbol,aweight,observations from nutrienttype";

    public SelectAllNutrientTypeDetails() {
    }
