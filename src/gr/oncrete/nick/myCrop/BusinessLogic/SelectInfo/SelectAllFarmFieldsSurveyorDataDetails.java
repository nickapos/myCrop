 ...
 */
/*
 * this class will retrieve the data needed from the surveyor
 */
 ...
 * @author nickapos
 */
public class SelectAllFarmFieldsSurveyorDataDetails extends SelectAllIDS {

    protected ArrayList rows = new ArrayList();
    protected String sql1 = "select fid,fieldname from farmfield";

    public SelectAllFarmFieldsSurveyorDataDetails() {
    }
    ...
    protected void readDBReport() {
        ...
        if (results.isEmpty()) {
            ...
            for (int i = 0; i < results.size(); i += 2) {
                //with ids
                String [] row = { (String)results.get(i),(String) results.get(i + 1) };
